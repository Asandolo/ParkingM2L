			...
			<div class="col-md-12 black">
				...
				<center>
					...
					<?php
						...
						$historique = $bdd->prepare("SELECT RESERVER.id_membre,RESERVER.id_place,num_place,date_debut_periode,date_fin_periode FROM MEMBRE, PLACE, RESERVER WHERE MEMBRE.id_membre = RESERVER.id_membre AND PLACE.id_place=RESERVER.id_place AND RESERVER.id_membre=? RESERVER.date_debut_periode < ? ORDER BY date_fin_periode DESC LIMIT 0,2");
